...
class CSVData:
    ...
    def get_values_of_object():
        return [self.fix, self.ns, self.nd, self.nf, self.entrophy, self.la, self.ld, self.lt, self.ndev, self.age, self.nuc, self.exp, self.rexp, self.sexp, self.contains_bug, self.author_date_unix_timestamp, self.commit_type, self.commit_id ]
