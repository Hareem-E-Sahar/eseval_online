...
# stuck at 9a7af71ae489ce126c0a57c90c8b7e8ac5bb5185

def process_commits(fixing_commits,buggy_commits_list,writer):
...
def match_buggy_and_fixing(fixing_commits,buggy_commits_list):
	...
	process_commits(fixing_commits,buggy_commits_list,writer)
